...
public class CategoriesService  extends HttpServlet {
    ...
    private static List<String> getIdFondsByCategorySearchCodeFromMS(String categorySearchCode, String personalCategoryName) {
            ...
            if (msResponse != null) {
                ...
                for (JsonElement element : rows) {
                    ...
                    if (property != null) {
                        ...
                        funds.put(id + "#" + personalCategoryName,name);
        ...
        //reduce the map to remove funds which are duplicated
        //example :
        //"Pictet-Russia Index P USD" : isin : LU0625741946
        //"Pictet-Russia Index P EUR" : isin : LU0625742753
    ...
    public static JsonObject getCategories() {
        ...
        categoryAfriqueEtMoyenOrient.addProperty("categoryNumber",categoriesMs.size());
        ...
        categoryAllocationDiversifiees.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categoryAmeriqueDuNord.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categoriesMs.add(createMsCategory("Actions Asie hors Japon Petites & Moy. Cap.",categoriesMsCodes));
        categoriesMs.add(createMsCategory("Actions Asie-Pacifique avec Japon",categoriesMsCodes));
        categoriesMs.add(createMsCategory("Actions Pacifique hors Japon",categoriesMsCodes));
        ...
        categoryAsieEtPacifique.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categoryEuropeEtZoneEuro.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categoryInternationales.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
...
//        categoriesMs.add(createMsCategory("Actions Secteur Marchés Emergents Autres",categoriesMsCodes));
        ...
        categoriesMs.add(createMsCategory("Actions Marchés Emergents Petites & Moy. Cap.",categoriesMsCodes));
        ...
        categoryPaysEmergents.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categoryPaysEuropeens.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
        ...
        categorySectoriels.addProperty("categoryNumber",categoriesMs.size());
        totalCategory+=categoriesMs.size();
...
//        categoriesMs = new JsonArray();
//        categoriesMs.add(createMsCategory("Asia-Pacific ex-Japan Equity Income",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Actions Chariah Islamique Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Actions Chine - A Shares",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Actions International Chariah Islamique",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Japan Flex-Cap Equity",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Global Emerging Markets Small/Mid-Cap Equity",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Pacific ex-Japan Equity",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Actions Secteur Non-Coté",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Actions Suède Grandes Cap.",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation Asie",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation CHF Agressive",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation CHF Modérée",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation CHF Prudente",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation GBP Agressive",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation GBP Flexible",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation GBP Modérée",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("GBP Moderately Adventurous Allocation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("GBP Moderately Cautious Allocation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation GBP Prudente",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Greater China Allocation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("NOK Aggressive Allocation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation SEK Agressive",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation SEK Flexible",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation SEK Modérée",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Allocation SEK Prudente",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Arbitrage Dette",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Devises",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Event Driven",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Actions - Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Actions - Europe",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Actions - International",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Actions - UK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Actions - US",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Long/Short Obligations",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Market Neutral - Actions",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Multistratégies",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Systematic Futures",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Alt - Volatilité",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles Europe",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles International",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles International Couvertes CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles International Couvertes en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles International Couvertes GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Convertibles International Couvertes USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à Capital Protégé",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2016-2020",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2021-2025",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2026-2030",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2031-2035",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2036-2040",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2041-2046",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds à horizon 2046+",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Fonds Garantis",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Immobilier - Direct International",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Matières Premières - Divers",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Matières Premières - Métaux Précieux",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires Autres Devises",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires EUR Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires GBP Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires USD Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations à échéance",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Asie",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Asie - Devise Locale",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Autres",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations CHF Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations RMB",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations DKK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("DKK Domestic Bond",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Diversifiées",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Diversifiées Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Emprunts d'Etat",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Emprunts d'Etat Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Emprunts Privés Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Indexées sur l'Inflation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations EUR Très Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Europe Emergente",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Europe",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations GBP Diversifiées",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations GBP Emprunts d'Etat",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations GBP Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations GBP Flexibles",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations GBP Indexées sur l'Inflation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations HDK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Chariah Islamique",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Couvertes en CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Couvertes en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Couvertes en GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Couvertes en NOK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Couvertes en USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Dominante CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Emprunts Privés - Couvertes en CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Emprunts Privés - Couvertes en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Emprunts Privés - Couvertes en GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Emprunts Privés Couvertes en USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Flexibles",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Flexibles Couvertes en CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Flexibles Couvertes en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Flexibles Couvertes en GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Flexibles Couvertes en USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Internationales Haut Rendement Couvertes en CHF",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Haut Rendement Couvertes en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International Haut Rendement Couvertes en GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations International ILS",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires  Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires Court Terme Couverte en EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires USD Court Terme Couverte en GBP",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Monétaires Court Terme Couverte en USD",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations JPY",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Marchés Emergents",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Marchés Emergents Devise Locale",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Marchés Emergents Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations Marchés Emergents Emprunts Privés Dominante EUR",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations NOK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations NOK Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("NOK High Yield Bond",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("RMB Bond - Onshore",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations SEK",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations SEK Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Diversifiées",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Diversifiées Court Terme",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Emprunts d'Etat",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Emprunts Privés",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Flexibles",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Obligations USD Indexées sur l'Inflation",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Swap EONIA PEA",categoriesMsCodes));
//        categoriesMs.add(createMsCategory("Trading - Leveraged/Inverse Matières Premières",categoriesMsCodes));
//        categoryAutres.add("categoriesMs",categoriesMs);
//        categoryAutres.addProperty("categoryNumber",categoriesMs.size());
//        totalCategory+=categoriesMs.size();
//        persoCategories.add(categoryAutres);


        result.add("personalCategories",persoCategories);
        result.addProperty("totalCategories",totalCategory);
